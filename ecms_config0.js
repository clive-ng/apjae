...
// home (example menu)
ECMS_add_item(0, 'Name list', 'name.htm','m');
ECMS_add_item(0, 'Past abstracts', 'pabstracts','m');
ECMS_add_item(0, 'Subscription form', 'subscription.htm','m');
ECMS_add_item(0, 'Note for contributors, 'note.htm','m');
ECMS_add_item(0, 'Messages from<br>eminent scholars,'m');
ECMS_add_item(1, 'Conference', 'pe_aaconference.htm','m');
ECMS_add_item(0, 'Competitions', 'pe_cl.htm','m');
ECMS_add_item(0, 'Enhancement Activities<br><br>','pe_ea.htm','m');
ECMS_add_item(1, 'Physical Education<br>Camp<br><br>', 'pe_eapec.htm','m');
ECMS_add_item(1, 'Immersion Programmes<br><br>', 'pe_eaip.htm','m');
ECMS_add_item(1, 'Student Exchange<br>Programmes<br><br>', 'pe_easep.htm','m');
ECMS_add_item(0, 'Awards &<br>Scholarships<br><br>', 'pe_awards.htm','m');
ECMS_end_menu();
