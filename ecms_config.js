...
// home (example menu)
ECMS_add_item(0, 'Home<br><br><br>', 'front.htm','m');
ECMS_add_item(0, 'Current Issue<br><br><br>', 'current.htm','m');
ECMS_add_item(0, 'Back Issue<br><br><br>', 'pabstracts.htm','m');
ECMS_add_item(0, 'International Advisory <br> Editorial Board<br><br><br>', 'advisory.htm','m');
ECMS_add_item(0, 'Note for <br>contributors<br><br><br>', 'note.htm','m');
ECMS_add_item(0, 'Subscription Form<br><br><br>','subscription.htm','m');
ECMS_add_item(0, 'Contact Us<br><br><br>', 'contact.htm','m');
ECMS_end_menu();
